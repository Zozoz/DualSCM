...
tf.app.flags.DEFINE_string('data_dir', 'data/yelp-2013/', 'data path')
tf.app.flags.DEFINE_string('train_file', 'yelp-2013-o/train.txt', 'training file')
tf.app.flags.DEFINE_string('val_file', 'yelp-2013-o/dev.txt', 'validating file')
tf.app.flags.DEFINE_string('test_file', 'yelp-2013-o/test.txt', 'testing file')
tf.app.flags.DEFINE_string('embedding_file', 'yelp-2013-o/yelp-2013-word2vec-200.txt', 'embedding file')
tf.app.flags.DEFINE_string('word_id_file', 'word_id.txt', 'word-id mapping file')
tf.app.flags.DEFINE_string('aspect_id_file', 'aspect_id.txt', 'word-id mapping file')

tf.app.flags.DEFINE_string('train_file_r', 'yelp-2013-r/train.txt', 'training file')
tf.app.flags.DEFINE_string('val_file_r', 'yelp-2013-r/dev.txt', 'validating file')
tf.app.flags.DEFINE_string('test_file_r', 'yelp-2013-r/test.txt', 'testing file')
tf.app.flags.DEFINE_string('embedding_file_r', 'yelp-2013-r/yelp-2013-word2vec-200.txt', 'embedding file')

tf.app.flags.DEFINE_string('method', 'AE', 'model type: ')
